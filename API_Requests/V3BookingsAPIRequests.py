...
class BookingsAPIRequestsV3:
    ...
    def __init__(
        ...
        self.header_fomatsonfleet = fleetAuthorizationV2().MATSONInteg_autho_matsonfleet()
    ...
    def assign_booking(self):
        try:
            ...
            response_1 = requests.post(
                url, json=self.initial_request, headers=headers, verify=False, timeout=120
            )
    ...
    def update_booking(self):
        try:
            ...
            response_3 = requests.post(
                url, json=self.update_request, headers=headers, verify=False, timeout=120
            )
    ...
    def unassign_booking(self):
        try:
            ...
            response_7 = requests.post(
                url, json=self.unassign_request, headers=headers, verify=False, timeout=120
            )
